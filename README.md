...
Under the same analyst-review budget, the graph-based method achieved higher precision and recall while reducing the false-positive rate. The repository includes the analysis notebook, dataset documentation, results, research poster, and editable poster file.
