...
- **apache/superset** — Contributed a fix for SQL generation involving numeric `IN` filters with mixed integer and decimal values.  
  PR: [#42625](https://github.com/apache/superset/pull/42625) (approved)
...
- **OWASP/CheatSheetSeries** — Improved language consistency and US English usage across multiple OWASP security cheat sheets.  
  PR: [#2316](https://github.com/OWASP/CheatSheetSeries/pull/2316) (merged), [#2333](https://github.com/OWASP/CheatSheetSeries/pull/2333) (merged), [#2334](https://github.com/OWASP/CheatSheetSeries/pull/2334) (merged), [#2335](https://github.com/OWASP/CheatSheetSeries/pull/2335) (merged), [#2338](https://github.com/OWASP/CheatSheetSeries/pull/2338) (open)
...
- **NYUSEC Team** - Competitor on the NYU Security CTF Team on [CTF Time](https://ctftime.org/team/439).
